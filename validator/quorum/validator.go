...
func Validate(ctx context.Context, store *db.PebbleStore, quorumVotes types.QuorumVotes, computors computors.Computors, systemInfo types.SystemInfo, epoch uint16) (types.QuorumVotes, error) {
