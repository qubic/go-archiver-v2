...
func TestQubicModelToProto(t *testing.T) {
	...
	expectedProtoQuorumTickData := &protobuf.QuorumTickData{
		...
		QuorumDiffPerComputor: map[uint32]*protobuf.QuorumDiff{
			1: {
	...
	if diff := cmp.Diff(expectedProtoQuorumTickData, result, cmpopts.IgnoreUnexported(protobuf.QuorumTickData{}, protobuf.QuorumTickStructure{}, protobuf.QuorumDiff{})); diff != "" {
