...
func getDefaultPebbleOptions() *pebble.Options {
	...
	// FIXME enabling more than the l1 options breaks storing latest tick
	// to test delete current db and run. Stop service and run again.
	...
	pebbleOptions := pebble.Options{
		Levels: []pebble.LevelOptions{l1Options},
		//Levels: []pebble.LevelOptions{l1Options, l2Options, l3Options}, // FIXME leads to data corruption (last processed tick)
